...
<div class="card card-custom">
	<div class="card-body">
		<form class="form" id="form_noticia" action="{{action('BlogController@upNoticia')}}" method="POST">
		@csrf
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
						...
						<div class="input-group input-group-solid">
							<input type="text" class="form-control" placeholder="Título de la Noticia" id="titulo" name="titulo" required>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="input-group input-group-solid">
							<input type="text" class="form-control" placeholder="Video de la Noticia" name="video">
							<div class="input-group-append">
								<span class="input-group-text">
			...
			<div class="form-group text-right">
				<button type="button" class="btn btn-primary font-weight-bold btn-submit">Subir</button>
			</div>
