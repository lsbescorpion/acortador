...
<div class="card card-custom">
	<div class="card-body">
		<form class="form" id="form_save_user" action="{{action('UsersController@saveUser')}}" method="POST">
		@csrf
			<div class="row">
				<div class="col-md-4">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<div class="input-group input-group-solid">
							<input type="text" class="form-control" placeholder="Perfil" name="perfil_fb" required>
							<div class="input-group-append">
								<span class="input-group-text">
