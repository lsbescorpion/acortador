            ...
            <div class="d-flex">
                ...
                <div class="flex-shrink-0 mr-7">
                    <div class="symbol symbol-50 symbol-lg-120">
                        <img alt="Pic" src="{{asset('').'img'.$url->url->foto}}">
                    </div>
                </div>
                <!--end::Pic-->
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap mt-2">
                        ...
                        <div class="mr-3">
                            <div class="d-flex align-items-center mr-3">
                                ...
                                <span class="label label-light-success label-inline font-weight-bolder mr-1">{{$url->url->categoria->categoria}}</span>
                            </div>
                            ...
                            <div class="d-flex flex-wrap my-2">
                                <div class="text-muted font-weight-bold mr-lg-8 mr-5 mb-lg-0 mb-2">
									...
									</svg><!--end::Svg Icon--></span>{{$url->url->fecha}}
	                            </div>
                            </div>
                            <!--end::Contacts-->
                        </div>
                        ...
                        <div class="my-lg-0 my-1">
                        	<a href="#" class="btn btn-icon btn-primary btn-sm mr-2 btn-copy" date="{{$url->url->accion." ".asset('')."publica/".$url->url->categoria->categoria."/".$url->url->url_acortada}}" data-toggle="tooltip" title="" data-placement="top" data-original-title="Copiar Url Acortada">
                            	<i class="flaticon2-copy"></i>
                            </a>

                            <a href="#" class="btn btn-icon btn-primary btn-sm mr-2 btn-view" date="{{$url->url->id}}" data-toggle="tooltip" title="" data-placement="top" data-original-title="Estadisticas Url">
                            	<i class="flaticon2-line-chart"></i>
                            </a>

                            <a href="#" class="btn btn-icon btn-primary btn-sm btn-delete" date="{{$url->url->id}}" data-toggle="tooltip" title="" data-placement="top" data-original-title="Eliminar Url">
                    ...
                    <!--begin::Description-->
	                    ...
	                    <div class="d-flex mt-4 mt-sm-0">
	                        ...
	                        <span class="font-weight-bolder text-dark ml-4">{{($url->url->visitas > 0 ? round((1000 * $url->url->gananciasadsense / $url->url->visitas), 2) : 0)}}</span>
	                    </div>
	                    <!--end::Progress-->
	                </div>
                ...
                <!--begin: Item-->
               	<div class="d-flex align-items-center mr-20 my-1">
	                ...
	                <div class="d-flex flex-column text-dark-75">
	                    ...
	                    <span class="font-weight-bolder font-size-h5"><span class="text-dark-50 font-weight-bold">$ </span>{{(Auth::user()->roles[0]->name ==  "Administrador" ? round($url->url->gananciasadsense, 2, PHP_ROUND_HALF_DOWN) : (Auth::user()->roles[0]->name ==  "Moderador" ? round(($url->url->gananciasadsense*60)/100, 2, PHP_ROUND_HALF_DOWN) : round(($url->url->gananciasadsense*50)/100, 2, PHP_ROUND_HALF_DOWN)))}}</span>
	                </div>
	            </div>
